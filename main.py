...
if __name__ == '__main__':
    ...
    akk_vk_1 = vk.Vkontakte(os.getenv('VK_TOKEN'), input('Введите id или screen_name пользователя: '))
    akk_ya_1 = yandex_disk.YandexDisk(os.getenv('YA_TOKEN'), input('Введите имя папки что бы создать бекап: '))
